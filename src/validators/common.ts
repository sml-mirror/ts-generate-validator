...
export const equalValidator: EqualValidator = ({ property, value, customMessage, config }) => {
...
export const equalToValidator: DependOnValidator = ({ property, targetPropertyName, data, customMessage, config }) => {
