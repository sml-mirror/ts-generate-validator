...
export const trimValidator: BaseValidator = ({ property, customMessage, config }) => {
...
export const lowercaseValidator: BaseValidator = ({ property, customMessage, config }) => {
...
export const uppercaseValidator: BaseValidator = ({ property, customMessage, config }) => {
...
export const minLengthValidator: ThresholdValidator = ({ property, threshold, customMessage, config }) => {
...
export const maxLengthValidator: ThresholdValidator = ({ property, threshold, customMessage, config }) => {
...
export const urlValidator: BaseValidator = ({ property, customMessage, config }) => {
...
export const matchValidator: MatchValidator = ({ property, regexp, customMessage, config }) => {
